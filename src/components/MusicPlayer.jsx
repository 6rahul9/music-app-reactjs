...
//   return (
//     <div className="musicPlayer flex flex-col px-5 w-[100%] border-2 
//     border-black py-3 bg-[#232a4e] mt-5 rounded-xl">
...
//                 className = "w-[2rem] h-[2.5rem] border-2 border-white rounded-full" />

//                 <div className="details flex flex-col ml-4">
//                     <span className='text-[1rem] '>Tristan Bone Dry</span>
...
//             {/* TRACK  */}
//             <div className="track flex justify-between text-sm text-gray-500
//             flex-[2] items-center">
//                 <span>2:59</span>
//                 <img src={require("../img/Group 9.png")} className="w-[16rem]" alt=""/>
//                 <span>4:00</span>
//             </div>
